...
public class Citizen implements Rescuable, Simulatable {
	...
	public boolean isDead() {
		return (this.state == CitizenState.DECEASED);
	...
	public String toString() {
		...
		s += "HP: " + this.hp + "\n";
		s += "Toxicity: " + this.toxicity + "\n";
		s += "Blood Loss: " + this.bloodLoss + "\n";
		s += "CitizenState: " + this.state + "\n";
		if (this.getLocation().getX() == 0 && this.getLocation().getY() == 0)
			s += "Citizen is at base" + "\n";
		return s;
	}
