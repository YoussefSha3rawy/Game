...
public class ResidentialBuilding implements Rescuable, Simulatable {
	...
	public boolean hasCollapsed() {
		return this.getStructuralIntegrity() == 0;
	}
	...
	public String toString() {
		...
		if (this.getDisaster() != null && this.getDisaster().isActive())
			s += "Disaster : " + this.getDisaster().toString() +"\n";
		s += "Structural Integrity: " + this.structuralIntegrity + "\n";
		s += "Fire Damage: " + this.fireDamage + "\n";
		s += "Gas Level: " + this.gasLevel + "\n";
		s += "Foundation Damage: " + this.foundationDamage + "\n";
		s += "number of Occupants: " + this.getOccupants().size() + "\n";
		for (Citizen c : this.getOccupants()) {
			s += c.toString();
			s += "Citizen is in the building" + "\n";
		}
		return s;
	}
}
